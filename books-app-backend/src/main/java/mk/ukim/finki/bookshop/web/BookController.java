...
public class BookController {
    ...
    @GetMapping("/rent/{id}")
    @Operation(summary = "Rent a book", description = "Decreases available copies count by 1")
    ...
    @GetMapping("/rents")
    @Operation(summary = "Return all rented books for current user", description = "")
    ...
    @Operation(summary = "Returns most rented book", description = "")
    ...
    @Operation(summary = "Returns user with most rented books", description = "")
    ...
    @GetMapping("/rents/author")
    @Operation(summary = "Returns most rented book author", description = "")
    ...
    @GetMapping("/wishlist/rent")
    @Operation(summary = "Rent all books from wishlist", description = "")
